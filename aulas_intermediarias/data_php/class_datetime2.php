...
/*
    ...
    da classe DateTime), podemos tirar partido de vários métodos para operar os valores.
    Uma data e hora contém imensos parâmetros: ano, mês, dia, dia da semana, hora, minuto,
    segundo, etc.
    Existem vários métodos para alterar os valores da data e hora, adicionando
    períodos de tempo.
    Vejamos.
*/
